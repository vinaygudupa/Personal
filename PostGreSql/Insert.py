...
class Postgresql(object):
    def __init__(self):
        ...
        self.databases = [
            'plivo_cloud', 'dbcfg-master-qa.voice.plivodev.com', 'plivocfg', 'hello', '5432']

    def _create_ssh_tunnel_to_DbCfg(self):
        try:
    ...
    def _connect_to_dbCfg(self):
        try:
            if not self.server:
                self._create_ssh_tunnel_to_DbCfg()
